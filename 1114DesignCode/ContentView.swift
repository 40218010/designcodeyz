...
//  1114DesignCode
//
//  Created by Yahsuan on 14/11/2020.
...
struct CardBottomView: View {
    var body: some View {
        VStack(spacing: 20.0) {
            ...
            Text("This certificate is proof that Yahsuan To has achieved the UI Design course with approval from a Design+Code instructor.")
                .lineLimit(10)
            Spacer()
        }
